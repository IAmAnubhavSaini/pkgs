...
const concordance_1 = require("./concordance");
describe("@concordance", () => {
    ...
    it("finds the concordance", () => {
        ...
        const [lines, numbers] = (0, concordance_1.concordance)(text, word);
    ...
    it("finds the case sensitive only concordance", () => {
        const word = "Monstrous";
        const [lines, numbers] = (0, concordance_1.concordanceCaseSensitive)(text, word);
        expect(lines.length).toEqual(1);
        expect(numbers.length).toEqual(1);
    });
    it("cannot find the concordance if text is empty", () => {
        const word = "monstrous";
        const [lines, numbers] = (0, concordance_1.concordance)([], word);
        expect(lines.length).toEqual(0);
        expect(numbers.length).toEqual(0);
    });
    it("cannot find the case sensitive only concordance if text is empty", () => {
        const word = "Monstrous";
        const [lines, numbers] = (0, concordance_1.concordanceCaseSensitive)([], word);
        expect(lines.length).toEqual(0);
        expect(numbers.length).toEqual(0);
    });
});
//# sourceMappingURL=concordance.spec.js.map